...
func init() {
	...
	stitchDiscoverCmd.Flags().BoolVar(&discoverAutoStitchFlag, "auto-stitch", false, "Automatically stitch all discovered hosts without prompt")
	stitchDiscoverCmd.Flags().BoolVar(&discoverAutoStitchFlag, "all", false, "Alias for --auto-stitch")
